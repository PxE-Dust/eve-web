...
/* ---------------- NATURAL HANGING VINES WITH PHYSICS & BREEZE ---------------- */
...
function OrganicHangingVines() {
  ...
  const physicsSpringLeft = useSpring(rawScrollAngleLeft, { stiffness: 25, damping: 8, mass: 1.2 });
  const physicsSpringRight = useSpring(rawScrollAngleRight, { stiffness: 25, damping: 8, mass: 1.2 });

  return (
    <div className="pointer-events-none absolute top-full inset-x-0 h-[380px] z-10 overflow-visible opacity-75">
      {/* Left Lush Vine Branch */}
      <motion.div
        style={{ rotate: physicsSpringLeft, transformOrigin: "top left" }}
        animate={{
          rotate: [0, 2.5, -1.5, 3, 0],
          skewX: [0, 1, -1, 0],
        }}
        transition={{
          duration: 7,
        ...
        className="absolute top-0 left-0 w-80 h-[380px]"
      >
        <svg className="w-full h-full text-[#1C2E20]" viewBox="0 0 260 320" fill="none" stroke="currentColor">
          {/* Main Vines */}
          <path d="M 0 0 C 50 80, 20 160, 70 280" strokeWidth="2.5" strokeLinecap="round" />
          <path d="M 0 0 C 90 50, 100 150, 140 230" strokeWidth="1.8" strokeLinecap="round" />
          <path d="M 0 0 C 30 110, 10 200, 35 310" strokeWidth="1.2" strokeLinecap="round" />

          {/* Leaf Clusters & Foliage */}
          {/* Top Dense Pack */}
          <path d="M 12 20 Q 32 10 22 35 Q 2 32 12 20 Z" fill="currentColor" stroke="none" />
          <path d="M 28 30 Q 50 20 38 48 Q 18 45 28 30 Z" fill="currentColor" stroke="none" />
          <path d="M 45 22 Q 68 18 55 42 Q 32 40 45 22 Z" fill="currentColor" stroke="none" />

          {/* Mid Section Leaves */}
          <path d="M 28 95 Q 52 88 40 112 Q 20 110 28 95 Z" fill="currentColor" stroke="none" />
          <path d="M 42 145 Q 68 140 55 168 Q 32 165 42 145 Z" fill="currentColor" stroke="none" />
          <path d="M 82 80 Q 106 75 94 100 Q 72 98 82 80 Z" fill="currentColor" stroke="none" />
          <path d="M 110 140 Q 135 135 120 160 Q 98 158 110 140 Z" fill="currentColor" stroke="none" />
          <path d="M 128 190 Q 152 185 138 210 Q 115 208 128 190 Z" fill="currentColor" stroke="none" />

          {/* Hanging Tips */}
          <path d="M 52 220 Q 72 215 62 238 Q 42 235 52 220 Z" fill="currentColor" stroke="none" />
          <path d="M 64 265 Q 80 260 72 280 Q 55 278 64 265 Z" fill="currentColor" stroke="none" />
          <path d="M 32 295 Q 48 292 40 310 Q 25 308 32 295 Z" fill="currentColor" stroke="none" />
        </svg>
      </motion.div>

      {/* Right Lush Vine Branch */}
      <motion.div
        ...
        className="absolute top-0 right-0 w-80 h-[380px]"
      >
        <svg className="w-full h-full text-[#1C2E20] transform scale-x-[-1]" viewBox="0 0 260 320" fill="none" stroke="currentColor">
          {/* Main Vines */}
          <path d="M 0 0 C 50 80, 20 160, 70 280" strokeWidth="2.5" strokeLinecap="round" />
          <path d="M 0 0 C 90 50, 100 150, 140 230" strokeWidth="1.8" strokeLinecap="round" />
          <path d="M 0 0 C 30 110, 10 200, 35 310" strokeWidth="1.2" strokeLinecap="round" />
...
export default function App() {
  ...
  return (
    <div className="relative bg-[#EFF4EC] text-[#273229] min-h-screen antialiased overflow-x-hidden font-['Plus_Jakarta_Sans',sans-serif]">
      ...
      {/* TOP NAVBAR (SCROLLS WITH PAGE + ANCHORED VINES) */}
      <Navbar />
...
/* ---------------- NAVBAR WITH ANCHORED VINES ---------------- */

function Navbar() {
  return (
    <header className="relative w-full z-30 bg-[#EFF4EC] border-b border-[#1C2E20]/15">
      ...
      {/* VINES ATTACHED TO THE BOTTOM OF THIS NAVBAR */}
      <OrganicHangingVines />
    </header>
  );
}
