    ...
    <g>
      ...
      {leaves.map((leaf, idx) => (
        ...
        >
          {/* Leaf Shape */}
          <path
            d={`M 0 0 C ${leaf.r * 1.2} -${leaf.r * 0.8}, ${leaf.r * 2} -${leaf.r * 0.2}, ${leaf.r * 2.2} 0 C ${
              leaf.r * 2
            } ${leaf.r * 0.8}, ${leaf.r * 1.2} ${leaf.r * 0.2}, 0 0 Z`}
            fill={color}
          />
          {/* Subtle Leaf Center Vein */}
          <path d={`M 0 0 L ${leaf.r * 1.8} 0`} stroke="#A6C49F" strokeWidth="0.6" opacity="0.6" />
        </motion.g>
      ))}
    </g>
  );
...
function OrganicHangingVines() {
  ...
  // Inertia rotation for vine sway
  ...
  const springLeft = useSpring(rawScrollAngleLeft, { stiffness: 15, damping: 7, mass: 1.3 });
  const springRight = useSpring(rawScrollAngleRight, { stiffness: 15, damping: 7, mass: 1.3 });
  ...
  return (
    <div className="pointer-events-none absolute top-full inset-x-0 h-[850px] z-10 overflow-visible">
        ...
        <svg className="w-full h-full" viewBox="0 0 320 820" fill="none">
          ...
          <PhysicsLeafBranch
            ...
            leaves={[
              ...
              { cx: 15, cy: 210, r: 13, rot: -45 },
              { cx: 25, cy: 300, r: 15, rot: 25 },
              { cx: 45, cy: 410, r: 14, rot: -30 },
              { cx: 70, cy: 520, r: 16, rot: 40 },
              { cx: 80, cy: 620, r: 13, rot: -15 },
              { cx: 45, cy: 720, r: 11, rot: 30 },
          ...
          <PhysicsLeafBranch
            ...
            leaves={[
              ...
              { cx: 75, cy: 290, r: 13, rot: 40 },
              { cx: 115, cy: 400, r: 12, rot: -35 },
              { cx: 125, cy: 470, r: 10, rot: 15 },
              { cx: 45, cy: 560, r: 11, rot: -50 },
              { cx: 32, cy: 640, r: 9, rot: 20 },
            ]}
          />
        </svg>
      </motion.div>
      ...
      <motion.div
        ...
        className="absolute top-0 left-[18%] w-[240px] h-[580px] opacity-90 hidden sm:block"
      >
        <svg className="w-full h-full" viewBox="0 0 240 580" fill="none">
          <PhysicsLeafBranch
            ...
            leaves={[
              ...
              { cx: 105, cy: 240, r: 12, rot: 35 },
              { cx: 130, cy: 340, r: 14, rot: -20 },
              { cx: 150, cy: 440, r: 11, rot: 45 },
              { cx: 132, cy: 530, r: 9, rot: -10 },
            ]}
          />
        </svg>
      </motion.div>
      ...
      <motion.div
        ...
        className="absolute top-0 right-[18%] w-[240px] h-[620px] opacity-90 hidden sm:block"
      >
        <svg className="w-full h-full" viewBox="0 0 240 620" fill="none">
          <PhysicsLeafBranch
            ...
            leaves={[
              ...
              { cx: 140, cy: 270, r: 12, rot: -45 },
              { cx: 105, cy: 370, r: 14, rot: 30 },
              { cx: 82, cy: 480, r: 11, rot: -15 },
              { cx: 108, cy: 580, r: 9, rot: 20 },
            ]}
          />
        </svg>
      </motion.div>
        ...
        <svg className="w-full h-full transform scale-x-[-1]" viewBox="0 0 320 840" fill="none">
          ...
          <PhysicsLeafBranch
            ...
            leaves={[
              ...
              { cx: 15, cy: 220, r: 13, rot: -45 },
              { cx: 25, cy: 310, r: 15, rot: 25 },
              { cx: 45, cy: 420, r: 14, rot: -30 },
              { cx: 70, cy: 530, r: 16, rot: 40 },
              { cx: 80, cy: 640, r: 13, rot: -15 },
              { cx: 45, cy: 740, r: 11, rot: 30 },
          ...
          <PhysicsLeafBranch
            ...
            leaves={[
              ...
              { cx: 75, cy: 300, r: 13, rot: 40 },
              { cx: 115, cy: 420, r: 12, rot: -35 },
              { cx: 125, cy: 490, r: 10, rot: 15 },
              { cx: 45, cy: 580, r: 11, rot: -50 },
              { cx: 32, cy: 660, r: 9, rot: 20 },
            ]}
          />
        </svg>
      </motion.div>
